...
const EditTodo = ({ todo }) => {
    ...
    return (
        <>
            <div>
                <button type="button" className="btn btn-warning" data-toggle="modal" data-target={`#todoModal-${todo.todo_id}`} onClick={() => setDescription(todo.description)}>
                    Edit
                </button>
                <div className="modal" id={`todoModal-${todo.todo_id}`}>
